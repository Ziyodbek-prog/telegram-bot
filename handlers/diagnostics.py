...
async def cb_adm_diagnostics(call: types.CallbackQuery):
    ...
    try:
        ...
        await call.message.answer(f"❌ Diagnostikada xatolik yuz berdi:\n`{e}`", parse_mode="Markdown")
...
async def cb_adm_toggle_m(call: types.CallbackQuery):
    ...
    try:
        ...
        await call.message.answer(f"❌ Rejimni o'zgartirishda xatolik: {e}")
    await call.answer()
...
async def cb_adm_stats(call: types.CallbackQuery):
    ...
    try:
        ...
        await call.message.answer(f"❌ Statistikani olishda xatolik: {e}")
    await call.answer()
